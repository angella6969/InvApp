...
<div class="table-responsive col-lg-11">
    ...
    {{-- <a href="/users/create" class="btn btn-primary mb-2"><span data-feather="user-check"></span> Activated New
        User</a> --}}
    ...
    <table class="table table-striped table-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                @can('Admin')
                <td>
                    <a href="/users/{{ $barang->id }}" class="badge bg-info border-0 d-inline"><span
                            data-feather="eye"></span></a>
                    <a href="/users/{{ $barang->id }}/edit" class="badge bg-warning border-0 d-inline"><span
                            data-feather="user-check"></span></a>
